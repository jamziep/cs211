...
//     ///
//     /// ```
//     /// return Piece_set{p1, p2};
//     /// ```
//     Piece_set(std::initializer_list<value_type> elems);
//
...
//     /// ...
//     ///
//     /// Piece_set pos_set(v.begin(), v.end());
//     /// ```
//     template <class FWD_ITER>
//     explicit Piece_set(FWD_ITER begin, FWD_ITER end);
//
//
//     //
//     // BASIC OPERATIONS
...
//     Piece_set operator&(Piece_set) const;
//
...
//     ///
//     /// ```
//     /// CHECK( ~Piece_set() == Piece_set::universe() );
//     /// ```
...
//     static Position position_of_(std::size_t);
//     iterator iterator_(Position) const;
// };
//
//
// // Iterator class, declared above inside Piece_set and defined right here:
// class Piece_set::iterator
//         : public std::iterator<
//                 std::input_iterator_tag,
//                 Piece_set::value_type const>
// {
//     bits_t const *bits_;
//     Piece_set::value_type current_;
//
// public:
...
// /// `Piece_set`s).
// bool
// operator==(Piece_set::iterator, Piece_set::iterator);
//
...
// template <class FWD_ITER>
// Piece_set::Piece_set(FWD_ITER begin, FWD_ITER end)
// {
//     for (; begin != end; ++begin) {
//         (*this)[*begin] = true;
//     }
